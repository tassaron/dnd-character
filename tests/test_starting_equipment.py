...
def test_starting_equipment_barbarian():
...
def test_starting_equipment_bard():
...
def test_starting_equipment_cleric():
...
def test_starting_equipment_druid():
...
def test_starting_equipment_fighter():
...
def test_starting_equipment_paladin():
...
def test_starting_equipment_ranger():
...
def test_starting_equipment_rogue():
...
def test_starting_equipment_sorcerer():
...
def test_starting_equipment_warlock():
...
def test_starting_equipment_wizard():
